$(document).ready(function () {
	...
	var qbank = [
        ["これは<br>ココヤシの木<br>ですか？", "ダー<br>オウンビン<br>ラー"],
		["違います。", "マホウッブー"],
		["それは<br>オウギヤシの木<br>です。", "エーダー<br>タンビン<br>バー"],
		["これは<br>何ですか？", "ダー<br>バーレー"],
		["それは<br>マンゴーの木<br>です。" , "エーダー<br>タ・ヤェッ・ビン<br>バー"],
		["それは<br>何ですか？", "エーダー<br>バーレー"],
		["あれは<br>何ですか？", "ホーハー<br>バーレー"],
		["それは<br>鉛筆<br>です。", "エーダー<br>ケーダン<br>バー"],
		["これは<br>犬<br>です。", "ダー<br>クウェー<br>バー"],
		["あれは<br>りんご<br>です。", "ホーハー<br>パンティー<br>バー"]
    ];
    ...
    function beginActivity() {
        ...
        if (firstCard === 0) {
            ...
            // card2/答えが上
            $("#card1").css("top", "-250px"); // card1を上に隠す
            $("#card2").css("top", "0px");
        }
        ...
        $("#cardArea").on("click", function () {
            ...
            if (cardState == 0) {
                ...
                $("#card1").animate({ top: "-=250" }, 150);
                $("#card2").animate({ top: "-=250" }, 150, function () {
        ...
        $("#buttonArea").append('<div id="otherButton"> <a href="./phrase_card_list.html" style="text-decoration:none;">Choose Others</a></div>');
    ...
    function displayFinalMessage() {
        $("#buttonArea").empty();
        $("#cardArea").empty();
        $("#cardArea").append('<div id="finalMessage"><p>終了！<br>よく頑張りました！</p></div>');
        $("#buttonArea").append('<div id="otherButton"> <a href="./phrase_card1.html" style="text-decoration:none;">最初からやり直す</a></div>');
        $("#buttonArea").append('<div id="otherButton"> <a href="./phrase_card_list.html" style="text-decoration:none;">他の練習を選ぶ</a></div>');
    }
