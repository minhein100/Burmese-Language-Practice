$(document).ready(function () {
    ...
    function beginActivity() {
        ...
        $("#buttonArea").append('<div id="otherButton"> <a href="./vocab_card_list.html" style="text-decoration:none;">Choose Others</a></div>');
    ...
    function displayFinalMessage() {
        $("#buttonArea").empty();
        $("#cardArea").empty();
        $("#cardArea").append('<div id="finalMessage"><p>終了！<br>よく頑張りました！<br>フレーズに挑戦しましょう！</p></div>');
        $("#buttonArea").append('<div id="otherButton"> <a href="./vocab_card1.html" style="text-decoration:none;">最初からやり直す</a></div>');
        $("#buttonArea").append('<div id="otherButton"> <a href="./vocab_card_list.html" style="text-decoration:none;">他の練習を選ぶ</a></div>');
    }
